...
```{r}
dshw_model = dshw(training, period1=4, period2 = 12, h=84)
...
dshw_model_2 = dshw(training, period1=6, period2 = 12, h = 60)
...
```{r}
fit_arima <- auto.arima(training, d = 1, D = 1, stepwise = FALSE, approximation = FALSE, trace = TRUE)
...
```{r}
fcst_arima <- forecast(fit_arima_training, h = 60)
