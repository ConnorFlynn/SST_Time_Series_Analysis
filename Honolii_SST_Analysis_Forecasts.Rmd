...
Let's discuss the parameters I chose to put in the model. For the longer period in the model,I chose to break up the 36 years(432 months) into 12 year (144 month) periods. Period 2 = 144. For the shorter period in the model, I chose to separate the data into 36, 4 month periods. Period 1 = 36. Notice, Period 1 & 2 are integer multiples of the other. 
